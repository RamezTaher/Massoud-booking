export class Endpoints {
  ...
  public static account_user_get = '/Account/GetUser';
  public static account_user_update = '/Account/EditUser';
  public static reservations_get = '/Booking/GetBookings';
  public static hotels_metadata = '/Hotels/HotelsMetadata';
  public static transportation_vehicles_get = '/Transportation/GetVehicles';
  public static transportation_categories_get = '/Transportation/GetCategories';
  public static transportation_actions_get = '/Transportation/GetActions';
  public static transportation_pricings_get =
    '/Transportation/GetTransportationPricings';
  public static transportation_pricing_get =
    '/Transportation/GetTransportationPricing';
  public static transportation_add_reservation =
    '/Transportation/AddReservation';
  // Reservation_list ENDPOINT
}
